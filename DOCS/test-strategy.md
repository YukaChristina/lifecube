...
- ホームの合成パターン選択UIで、円形くりぬきは円内が内側写真、斜めカットは上側に近い領域が外側写真、左右分割は右側が内側写真として見えるか。
- ホームの合成パターン選択UIで、斜めカットが曲線分割に見え、3パターンの境界線色とトーンに統一感があるか。
- 斜めカットの合成画像で、縦向きでは境界が右上から左下へ抜ける曲線になり、上側に近い領域が外側写真、反対側が内側写真として表示されるか。
- 斜めカットの合成画像で、横向きでは曲線が単純な上下分割に近づきすぎず、縦向き基準を横へ倒した見え方になっているか。
