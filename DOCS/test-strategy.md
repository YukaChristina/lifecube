...
- 横向き撮影の撮影後プレビューで、中央だけが拡大表示されず、合成画像全体が見えるか。
- 縦向き撮影の撮影後プレビューが、従来どおり大きく崩れずに表示されるか。
...
- アルバム詳細の合成パターン切り替えが、2文字ラベルの `円形 / 斜め / 分割` の順で表示されるか。
- アルバム詳細で `円形`、`斜め`、`分割` を選択したときに、再合成、保存、表示更新が成功するか。
