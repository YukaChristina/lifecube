...
- MVP初期の合成後写真は、スマホ縦持ちを標準として `1080 x 1920` の9:16縦長で生成する。
- 将来的には、撮影時の端末向き、カメラが返す画像サイズ、元写真のアスペクト比、必要な共有先に応じて、合成画像の出力サイズと比率を変えられる設計にする。
...
横向き撮影に合わせた `16:9` 出力、撮影時の端末向きに応じた縦横切り替え、カメラ解像度や元写真比率を保った高画質出力は、MVP初期では扱わず将来検討とします。
